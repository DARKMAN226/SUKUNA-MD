...
const REPO_OWNER = 'DARKMAN226';
const REPO_NAME = 'SUKUNA-MD';
...
async (conn, mek, m, { from, reply }) => {
    try {
        ...
        let pluginList = "📂 *SUKUNA-MD Plugins:*\n\n";
...
async (conn, mek, m, { from, reply, args, senderNumber }) => {
    try {
        ...
        const statusMessage = {
            image: { url: `https://files.catbox.moe/2p8kp8.jpg` }, // Replace with your image URL

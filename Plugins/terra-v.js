...
cmd({
  ...
  try {
    ...
    const rawVersionUrl = 'https://raw.githubusercontent.com/Giffareno237/ARCHANGE-MD-V1/main/DATABASE/version.json';
    ...
    // GitHub stats
    const githubRepo = 'https://github.com/DARKMAN226/SUKUNA-MD';

    // Check update status
    let updateMessage = `*✅ 𝖸𝖮𝖴 SUKUNA－𝖬𝖣－𝖵𝟣 𝖡𝖮𝖸 𝖨𝖲 𝖴𝖯-𝖳𝖮-𝖣𝖠𝖳𝖤!*`;
    if (localVersion !== latestVersion) {
      updateMessage = `*😵‍💫 𝖸𝖮𝖴𝖱 SUKUNA－𝖬𝖣－𝖵𝟣 𝖨𝖲 𝖮𝖴𝖳𝖣𝖠𝖳𝖤𝖣*
    ...
    await conn.sendMessage(from, {
      ...
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          ...
          newsletterName: 'SUKUNA 𝐌𝐃 𝐕𝐄𝐑𝐒𝐈𝐎𝐍',
          serverMessageId: 143
        }
      }
    }, { quoted: mek });

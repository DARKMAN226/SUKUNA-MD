...
cmd(
  ...
  async (
    ...
    try {
      await _0x33b9fc('```\uD83D\uDD0D Checking for ARCHANGE-MD updates...💫```\n')
      const { data: _0x1258fc } = await axios.get(
          'https://api.github.com/repos/DARKMAN226\SUKUNA-MD/commits/main'
        ),
      ...
      if (_0x190d17 === _0x429064) {
        return _0x33b9fc(
          '```\u2705 Your ARCHANGE bot is already up-to-date!✅```\n'
        )
      }
      await _0x33b9fc('```ARCHANGE MD Bot Updating...\uD83D\uDE80```\n')
      const _0x4a7e72 = path.join(__dirname, 'latest.zip'),
        { data: _0x99182c } = await axios.get(
          'https://github.com/DARKMAN226/SUKUNA-MD/archive/main.zip',
      ...
      const _0x552090 = path.join(_0x74484, 'SUKUNA-MD-main'),

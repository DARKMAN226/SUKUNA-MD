...
const sessdata = config.SESSION_ID.replace("SUKU~", '');
...
let up = `*╭──────────────●●*
> *SUKUNA MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ sᴇᴇ ᴛʜᴇ ғᴜʟʟ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ🔖*
...
//================ownerreact==============
if(senderNumber.includes("221752238497")){
if(isReact) return
m.react("👑")
}
...
app.get("/", (req, res) => {
res.send("SUKUNA MD STARED GO AND ENJOY✅");
});
